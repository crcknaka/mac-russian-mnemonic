...
<!-- Russian Mnemonic layout for macOS. Reproduces Windows kbdrum.dll 1:1.
     group="7" is the legacy Cyrillic script code (smCyrillic) — with group="0"
     (Roman) TSM treats the layout as Latin and the "Use Caps Lock to switch
     to and from ABC" option never appears in System Settings. -->
<keyboard group="7" id="{LAYOUT_ID}" name="{LAYOUT_NAME}" maxout="2">
  <layouts>
